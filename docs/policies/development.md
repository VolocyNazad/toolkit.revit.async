...
## Revit API dependency

Keep Revit_All_Main_Versions_API_x64 visible to package consumers because public APIs expose Autodesk.Revit types. Control whether Revit assemblies are copied to application output through build metadata rather than PrivateAssets.
